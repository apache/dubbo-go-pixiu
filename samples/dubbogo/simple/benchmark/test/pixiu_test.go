...
//go tool pprof -http 0.0.0.0:3001 /Users/yangqing.xyq/GolandProjects/dubbo-go-pixiu/samples/dubbogo/simple/benchmark/test/cpu.prof
func BenchmarkPixiu(b *testing.B) {
	url := "http://localhost:8882/api/v1/test-dubbo/user/tc"
	data := "{\"id\":\"0001\",\"code\":1,\"name\":\"tc\",\"age\":66}"
	for n := 0; n < b.N; n++ {
		client := &http.Client{Timeout: 5 * time.Second}
