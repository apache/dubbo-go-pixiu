...
func TestPost1(t *testing.T) {
	url := "http://localhost:8881/UserService/com.dubbogo.pixiu.UserService/GetUserByName"
...
func TestPost2(t *testing.T) {
	url := "http://localhost:8881/UserService/com.dubbogo.pixiu.UserService/UpdateUserByName"
...
func TestPost3(t *testing.T) {
	url := "http://localhost:8881/UserService/com.dubbogo.pixiu.UserService/GetUserByCode"
