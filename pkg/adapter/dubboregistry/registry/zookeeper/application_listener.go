...
func newZkAppListener(client *zookeeper.ZooKeeperClient, reg *ZKRegistry, adapterID string) registry.Listener {
...
func (z *zkAppListener) handleEvent(children []string) {
	...
	for _, path := range children {
		...
		l := newApplicationServiceListener(serviceName, z.client, z.adapterID)
		l.wg.Add(1)
		go l.WatchAndHandle()
