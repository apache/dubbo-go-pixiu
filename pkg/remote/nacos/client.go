...
func (client *NacosClient) GetAllServicesInfo(param vo.GetAllServiceInfoParam) (xdsmodel.ServiceList, error) {
	return client.namingClient.GetAllServicesInfo(param)
}

func (client *NacosClient) SelectInstances(param vo.SelectInstancesParam) ([]xdsmodel.Instance, error) {
