...
import (
	...
	"pixiu-ingress-controller/internal/controller/indexer"
	"pixiu-ingress-controller/internal/controller/status"

	"pixiu-ingress-controller/internal/utils"
...
const (
	FinalizerGatewayClassProtection = "pixiu.apache.org/gc-protection"
)
...
func (r *GatewayClassReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	condition := meta.Condition{
		...
		Message:            "the gatewayclass has been accepted by the pixiu-ingress-controller",
